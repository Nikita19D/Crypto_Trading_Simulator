...
try:
    ...
    cursor.execute("INSERT INTO PORTFOLIOS (user_id,crypto_symbol,quantity,average_buy_price) VALUES(%s,%s,%s,%s)",(michel_id,'BTC',0.5,78058.4))
    cursor.execute("INSERT INTO PORTFOLIOS (user_id,crypto_symbol,quantity,average_buy_price) VALUES(%s,%s,%s,%s)",(marko_id,'ETH',2,2370.13))
    ...
    cursor.execute("INSERT INTO TRANSACTIONS (user_id,crypto_symbol,transaction_type,quantity,price_at_execution,total_value) VALUES (%s,%s,%s,%s,%s,%s)",
                   (michel_id,'BTC','BUY',0.5,78058.46,39029.23))
    cursor.execute("INSERT INTO TRANSACTIONS (user_id,crypto_symbol,transaction_type,quantity,price_at_execution,total_value) VALUES (%s,%s,%s,%s,%s,%s)",
                   (marko_id,'ETH','BUY',2,2370.13,4740.26))
